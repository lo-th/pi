...
-this.cfg.maxSpeed?-this.cfg.maxSpeed:this.ease.x-this.cfg.speed);this.key[0]||this.key[1]||(this.ease.z=this.ease.z>this.cfg.speed?this.ease.z-this.cfg.speed:this.ease.z<-this.cfg.speed?this.ease.z+this.cfg.speed:0);this.key[2]||this.key[3]||(this.ease.x=this.ease.x>this.cfg.speed?this.ease.x-this.cfg.speed:this.ease.x<-this.cfg.speed?this.ease.x+this.cfg.speed:0);0!==this.ease.z||0!==this.ease.x?(0>this.ease.x?this.player.stepLeft():0<this.ease.x&&this.player.stepRight(),0<this.ease.z?this.player.WalkFront():
0>this.ease.z&&this.player.WalkBack()):this.player.stopWalk();if(0!=this.ease.x||0!=this.ease.z||this.mouse.down){this.easeRot.y=this.cam.horizontal*V3D.ToRad;var a=this.unwrapDegrees(Math.round(this.cam.horizontal));this.easeRot.x=Math.sin(this.easeRot.y)*this.ease.x+Math.cos(this.easeRot.y)*this.ease.z;this.easeRot.z=Math.cos(this.easeRot.y)*this.ease.x-Math.sin(this.easeRot.y)*this.ease.z;this.player.setRotation(-(this.cam.horizontal+90)*V3D.ToRad);this.level.x=this.levelOrigin.x-this.easeRot.x;
this.level.z=this.levelOrigin.z+this.easeRot.z;this.miniMap.drawMap();var b=0,d=0,c=this.miniMap.lock;45<=a&&135>=a?(this.level.z<this.levelOrigin.z&&(c[0]||c[4]||c[5]||(d=1)),this.level.z>this.levelOrigin.z&&(c[1]||c[6]||c[7]||(d=1)),this.level.x<this.levelOrigin.x&&(c[2]||c[4]||c[6]||(b=1)),this.level.x>this.levelOrigin.x&&(c[3]||c[5]||c[7]||(b=1))):-45>=a&&-135<=a?(this.level.z>this.levelOrigin.z&&(c[0]||c[4]||c[5]||(d=1)),this.level.z<this.levelOrigin.z&&(c[1]||c[6]||c[7]||(d=1)),this.level.x>
this.levelOrigin.x&&(c[2]||c[4]||c[6]||(b=1)),this.level.x<this.levelOrigin.x&&(c[3]||c[5]||c[7]||(b=1))):45>a&&-45<a?(this.level.z>this.levelOrigin.z&&(c[2]||c[4]||c[6]||(d=1)),this.level.z<this.levelOrigin.z&&(c[3]||c[5]||c[7]||(d=1)),this.level.x<this.levelOrigin.x&&(c[0]||c[4]||c[5]||(b=1)),this.level.x>this.levelOrigin.x&&(c[1]||c[6]||c[7]||(b=1))):(this.level.z<this.levelOrigin.z&&(c[2]||c[4]||c[6]||(d=1)),this.level.z>this.levelOrigin.z&&(c[3]||c[5]||c[7]||(d=1)),this.level.x>this.levelOrigin.x&&
(c[0]||c[4]||c[5]||(b=1)),this.level.x<this.levelOrigin.x&&(c[1]||c[6]||c[7]||(b=1)));b&&(this.levelOrigin.x=this.level.x);d&&(this.levelOrigin.z=this.level.z);this.level.y=this.miniMap.posY+this.cfg.posY;this.levelOrigin.y=this.level.y;this.cfg.g=this.cfg.onGround?0:this.cfg.G;this.ease.y+=this.cfg.g*this.delta;this.miniMap.updatePosition(this.levelOrigin.x,-this.easeRot.y,this.levelOrigin.z);this.player.lerp(this.levelOrigin,0.5);this.moveCamera()}},moveCamera:function(){var a=this.player.getPosition().clone();
a.add(new THREE.Vector3(0,this.cam.py,0));this.camera.position.copy(this.Orbit(a,this.cam.horizontal,this.cam.vertical,this.cam.distance));this.camera.lookAt(a)},rayTest:function(a){if(0<this.content.children.length){var b=new THREE.Vector3(this.mouse.mx,this.mouse.my,1);this.projector.unprojectVector(b,this.camera);this.raycaster.set(this.camera.position,b.sub(this.camera.position).normalize());b=this.raycaster.intersectObjects(this.content.children);0<b.length&&(this.marker.position.set(0,0,0),
b[0].face&&this.marker.lookAt(b[0].face.normal),this.marker.position.copy(b[0].point),a&&this.shoot())}},shoot:function(){var a=this.bullets.length,b=new THREE.Mesh(this.bulletGeo,this.bulletMat);this.bulletContent.add(b);this.bullet.position.copy(this.player.position);this.bulletMoves[a]=this.marker.position.clone();this.bullets[a]=b},updateBullets:function(){for(var a=this.bullets.length;a--;)0.01>this.bullets[a].position.distanceTo(this.bulletMoves[a])?setTimeout(this.destroyBullet,1E3,a):this.bullets[a].position.lerp(this.bulletMoves[a],
0.1)},destroyBullet:function(a){this.bulletContent.remove(this.bullets[a]);this.bullets.slice(a,1);this.bulletMoves.slice(a,1)},activeMouse:function(){var a=this,b=document.body;document.addEventListener("contextmenu",function(a){a.preventDefault()},!1);b.addEventListener?(b.addEventListener("mousemove",function(b){a.onMouseMove(b)},!1),b.addEventListener("mousedown",function(b){a.onMouseDown(b)},!1),b.addEventListener("mouseup",function(b){a.onMouseUp(b)},!1),b.addEventListener("mouseout",function(b){a.onMouseUp(b)},
!1),b.addEventListener("touchstart",function(b){a.onMouseDown(b)},!1),b.addEventListener("touchend",function(b){a.onMouseUp(b)},!1),b.addEventListener("touchmove",function(b){a.onMouseMove(b)},!1),b.addEventListener("mousewheel",function(b){a.onMouseWheel(b)},!1),b.addEventListener("DOMMouseScroll",function(b){a.onMouseWheel(b)},!1)):b.attachEvent&&(b.attachEvent("onmousemove",function(b){a.onMouseMove(b)},!1),b.attachEvent("onmousedown",function(b){a.onMouseDown(b)},!1),b.attachEvent("onmouseup",
function(b){a.onMouseUp(b)},!1),b.attachEvent("onmouseout",function(b){a.onMouseUp(b)},!1),b.attachEvent("ontouchstart",function(b){a.onMouseDown(b)},!1),b.attachEvent("ontouchend",function(b){a.onMouseUp(b)},!1),b.attachEvent("ontouchmove",function(b){a.onMouseMove(b)},!1),b.attachEvent("onmousewheel",function(b){a.onMouseWheel(b)}))},onMouseDown:function(a){a.preventDefault();var b;a.touches?(b=a.clientX||a.touches[0].pageX,a=a.clientY||a.touches[0].pageY):(b=a.clientX,a=a.clientY);this.mouse.down=
!0;this.mouse.mx=b/this.vs.x*2-1;this.mouse.my=2*-(a/this.vs.y)+1;this.mouse.ox=b;this.mouse.oy=a;this.mouse.h=this.cam.horizontal;this.mouse.v=this.cam.vertical},onMouseUp:function(a){a.preventDefault();this.mouse.down=!1;document.body.style.cursor="auto"},onMouseMove:function(a){a.preventDefault();var b;a.touches?(b=a.clientX||a.touches[0].pageX,a=a.clientY||a.touches[0].pageY):(b=a.clientX,a=a.clientY);this.mouse.down?(document.body.style.cursor="move",this.cam.horizontal=0.3*(b-this.mouse.ox)+
this.mouse.h,this.cam.vertical=0.3*-(a-this.mouse.oy)+this.mouse.v):(this.mouse.mx=b/this.vs.x*2-1,this.mouse.my=2*-(a/this.vs.y)+1,this.rayTest())},onMouseWheel:function(a){a.preventDefault()},bindKeys:function(){var a=this;document.onkeydown=function(b){b=b||window.event;switch(b.keyCode){case 38:case 87:case 90:a.key[0]=1;break;case 40:case 83:a.key[1]=1;break;case 37:case 65:case 81:a.key[2]=1;break;case 39:case 68:a.key[3]=1;break;case 17:case 67:a.key[4]=1;break;case 69:a.key[5]=1;break;case 32:a.key[6]=
1;break;case 16:a.key[7]=1}};document.onkeyup=function(b){b=b||window.event;switch(b.keyCode){case 38:case 87:case 90:a.key[0]=0;break;case 40:case 83:a.key[1]=0;break;case 37:case 65:case 81:a.key[2]=0;break;case 39:case 68:a.key[3]=0;break;case 17:case 67:a.key[4]=0;break;case 69:a.key[5]=0;break;case 32:a.key[6]=0;break;case 16:a.key[7]=0}};self.focus()},unwrapDegrees:function(a){a%=360;180<a&&(a-=360);-180>a&&(a+=360);return a},Orbit:function(a,b,d,c){var e=new THREE.Vector3;d*=V3D.ToRad;b*=V3D.ToRad;
e.x=c*Math.sin(d)*Math.cos(b)+a.x;e.z=c*Math.sin(d)*Math.sin(b)+a.z;e.y=c*Math.cos(d)+a.y;return e},customShader:function(){return new THREE.ShaderMaterial({uniforms:{deep:{type:"f",value:0.03904}},attributes:{},vertexShader:"uniform float deep;\nvarying float dy;\nvarying vec4 vc;\nvoid main(void) {\ngl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\ndy = position.y*deep;\nvc = vec4(dy,dy,dy, 1.0);\n}",fragmentShader:"precision lowp float;\nvarying vec4 vc;\nvoid main(void) { gl_FragColor = vc; }"})}};V3D.Minimap=function(){this.ar8="undefined"!=typeof Uint8Array?Uint8Array:Array;this.miniSize={w:64,h:64,f:0.25};this.cc={r:255,g:0,b:0,a:255};this.miniGlCanvas=document.createElement("canvas");this.miniTop=document.createElement("canvas");this.mapTest=document.createElement("canvas");this.miniGlCanvas.width=this.miniTop.width=this.miniSize.w;this.miniGlCanvas.height=this.miniTop.height=this.miniSize.h;this.mapTest.width=16;this.mapTest.height=16;this.miniGlCanvas.style.cssText="position:absolute; bottom:10px; left:10px;";
...
THREE.AnimationHandler.update(a)},getPosition:function(){return this.obj.position},setPosition:function(a,b,d){this.obj.position.set(a,b,d)},setRotation:function(a){this.rotation.y=a;this.isMove&&(this.newRotation.lerp(this.rotation,0.25),this.obj.rotation.y=this.newRotation.y)},lerp:function(a,b){this.obj.position.lerp(a,b)},WalkFront:function(){this.model&&(this.timeScale=1,this.ease("walk"),this.isMove=!0)},WalkBack:function(){this.model&&(this.timeScale=-1,this.ease("walk"),this.isMove=!0)},stepLeft:function(){this.model&&
(this.ease("step_left"),this.isMove=!0)},stepRight:function(){this.model&&(this.ease("step_right"),this.isMove=!0)},stopWalk:function(){!this.model||0===this.W.walk&&0===this.W.step_right&&0===this.W.step_left||(this.ease("idle"),this.isMove=!1)},stop:function(a){},ease:function(a){for(var b=this,d=this.animLength,c,e={};d--;)c=this.animations[d].name,e[c]=a==c?1:0;this.tween=(new TWEEN.Tween(this.W)).to(e,1).easing(TWEEN.Easing.Linear.None).onUpdate(function(){b.weight()}).start()},weight:function(a){a=
this.animLength;for(var b;a--;)b=this.animations[a].name,this.animations[a].weight=this.W[b],"walk"==b&&(this.animations[a].timeScale=this.timeScale)}};
